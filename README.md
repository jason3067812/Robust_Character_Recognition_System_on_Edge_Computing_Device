...
Normal algorithms only compare anterior and posterior bounding boxes and cannot compare all the duplicate bounding boxes (When there are >= three bounding boxes on the same object). 
