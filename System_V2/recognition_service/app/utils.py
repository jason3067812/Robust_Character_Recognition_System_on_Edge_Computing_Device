...
def __get_det_boxes_core(text_map, link_map, text_threshold, link_threshold, low_text):
    # prepare data
    ...
    label_n, labels, stats, centroids = \
...
def get_det_boxes(text_map, link_map, text_threshold, link_threshold, low_text):
    boxes, labels, mapper = __get_det_boxes_core(
        text_map,
        link_map,
        text_threshold,
        link_threshold,
